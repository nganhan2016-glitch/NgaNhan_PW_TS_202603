...
//TH đặc biệt: cha ko có constructor , nhưng con víe contructor thì vẫn phải gọi super
class Base {
  sayHi() {
    return `Hi from base`;
  }
...
//cú pháp viết nhiều hàm cùng tên khác tham số (NHUNG KO CO body) + với 1 hàm thực 
