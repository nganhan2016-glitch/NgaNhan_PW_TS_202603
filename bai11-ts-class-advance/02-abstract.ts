...
//class con
class LoginPage5 extends BasePage1 {
    constructor() {
        super("/login");
    }
    isLoaded(): boolean {
...
//Nguyen tac: 1 class on tai chi de lam ban thiet ke cho class khac thi Nen LA ABstract. dung 
...
//2. can implement nhieu hop dong = da ke thua
...
// 3. instance of - chi check dc khi dung abstract

// COMBO: Abstract class + implement Interface
// Tai sao viec ket hop Abstract + Interface la dinh cao?
...
abstract class BaseTest {
    ...
    abstract getTestDate(): string;

}

class LoginTest extends BaseTest implements Runnable, Verifibable, Screenshotable {
    ...
    async execute(): Promise<void> {
        console.log("Nhap username va password");
        this.passed = true;
    }
    getTestData(): string {
